...
def select_best_model(**kwargs):
    ...
    X, y = prepair_data_to_ml('/app/clean_data/fulldata.csv')
...
with DAG(
    ...
    prepair_data_to_ml_task = PythonOperator(
        task_id='prepair_data_to_ml',
        python_callable=prepair_data_to_ml,
    )
...
prepair_data_to_ml_task >> training_tasks >> select_best_model_task